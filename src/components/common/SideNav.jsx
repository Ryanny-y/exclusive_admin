  ...
  return (
    ...
    >
      ...
      <nav className={`flex flex-col gap-10 main_nav ${styles.customScrollbar} pr-5`}>
        <section>
          <h3 className="font-medium text-gray-300 mb-4">Menu</h3>

          <ul className="flex flex-col gap-2 text-dark-100 font-medium dark:text-gray-100">
            <li className="group hover:bg-gray-200 dark:hover:text-light-100 duration-300 py-2 px-3 rounded-lg">
        ...
        <section>
          <h3 className="font-medium text-gray-300 mb-4">Account</h3>
         ...
         <section>
          <h3 className="font-medium text-gray-300 mb-4">More</h3>
